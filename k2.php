...
<div id="playerif" style="position: relative; ">
	...
	<div id="fbvideo" class="fb-video disable-click width-500 height-200" data-href="https://www.facebook.com/reel/3584482835156748" data-width="400" data-show-text="false" data-allowfullscreen="false" data-autoplay="true" data-show-captions="false">
	</div>
</div>
<br />
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-123638343-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-123638343-1');
</script>
